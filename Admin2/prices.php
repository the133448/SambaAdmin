...
//$con = mysqli_connect('localhost','coffee_web','$LpPvTAhb+1x','coffee_test');
$emP = "ok";
$emI = "ok";
$price = "";
$item = "";
...
if ($emP && $emI = "ok") {
  ...
  $sql = "REPLACE INTO Prices VALUES ('" . $item . "', '" . $price . "');";
...
?>
        ...
        <div class="container">
          ...
          <div class="dropdown">
            ...
            <form role="form" action="prices.php" method="post">
            ...
            <strong>Success!</strong> Changed ' . $item . ' The new price is: $' . $price;
            }
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="http://almsaeedstudio.com">Daniel Johns</a>.</strong> All rights
    reserved.
  </footer>
